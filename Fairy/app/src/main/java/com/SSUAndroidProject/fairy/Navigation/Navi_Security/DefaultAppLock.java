...
import com.SSUAndroidProject.fairy.MainActivity;
...
public class DefaultAppLock extends AbstractAppLock {
    ...
    public void onActivityResumed(Activity activity) { // 잠금 예외 할 엑티비티들.
        ...
        Write_Review Exception = new Write_Review();

        MainActivity Exception_3 = new MainActivity();
        Navi_ContactUs Exception_4 = new Navi_ContactUs();

        if(Exception.comeback&&activity.getClass().getName().equals("com.jstech.fairy.Fragment.Add_Diary.Write_Review")) {
